...
public class Exposicion {
    ...
    public Exposicion(String numeroExposcion, String direccion, String telefono) throws NullException, IsEmptyException, InvalidException {
        this.numeroExposcion = numeroExposcion;
        if(numeroExposcion == null) throw new NullException("Número de exposición no puede ser null");
