...
public class Validaciones {
    ...
    public void validatePrecioVenta(Double precioVenta) throws InvalidException {
        if(precioVenta < 0) throw new InvalidException("El precio de venta debe ser superior a 0");
    }

    public void validatePrecioCompra(Double precioCompra) throws InvalidException {
        if(precioCompra < 0) throw new InvalidException("El precio de compra debe ser superior a 0");
    }

    public void validateMatricula(String matricula) throws NullException, IsEmptyException, InvalidException {
    ...
    public void validateModelo(String modelo) throws NullException, IsEmptyException {
    ...
    //PERSONA
    public void validateTelefono(String telefono) throws NullException, IsEmptyException, InvalidException {
    ...
    public void validateDni(String dni) throws NullException, IsEmptyException, InvalidException {
    ...
    public void validateDireccion(String direccion) throws NullException, IsEmptyException {
    ...
    public void validateNombre(String nombre) throws NullException, IsEmptyException, InvalidException {
